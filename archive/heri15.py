...
def MakeGenderPlot(filename='heri15.csv'):
    """Generates a plot with the data, a fitted model, and error bars."""
    pyplot.clf()
...
def MakeChangePlot(filename='heri15.csv'):
    """Generates a plot with the data, a fitted model, and error bars."""
    pyplot.clf()
...
def main(script):
    ...
    thinkplot.Plot([2015], [29.6], 'bs')

    thinkplot.Save(root='heri15.1',
                formats=FORMATS,
                ylabel='Percent',
                loc=2,
    ...
    # add the actual value from 2015
    thinkplot.Plot([2015], [100 - 69.5], 'gs')

    thinkplot.Save(root='heri15.2',
                formats=FORMATS,
                ylabel='Percent',
                loc=2,
                   axis=[1967, UPPER, 0, 33])
