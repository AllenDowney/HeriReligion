...
def MakeGenderPlot(filename='heri16.csv'):
    """Generates a plot with the data, a fitted model, and error bars."""
    pyplot.clf()
    ...
    thinkplot.Save(root='heri16.3',
                   formats=FORMATS,
                   title='',
                   xlabel='',
                   ylabel='Preferred religion None (%)',
                   axis=[1967, UPPER, 0, 33])
...
def MakeChangePlot(filename='heri16.csv'):
    """Generates a plot with the data, a fitted model, and error bars."""
    pyplot.clf()
...
def main(script):
    ...
    # add the actual value from 2016
    #thinkplot.Plot([2016], [xx.x], 'bs')

    thinkplot.Save(root='heri16.1',
                   formats=FORMATS,
                   ylabel='Percent',
                   loc=2,
                   axis=[1967, UPPER, 0, 33])
    ...
    # add the actual value from 2015
    #thinkplot.Plot([2015], [100 - xx.x], 'gs')

    thinkplot.Save(root='heri16.2',
                   formats=FORMATS,
                   ylabel='Percent',
                   loc=2,
                   axis=[1967, UPPER, 0, 33])
